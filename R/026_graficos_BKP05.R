...
criar_e_salvar_grafico(
  tipo = "barra_vertical",
  df = passagem_cia_GERAL_HOM_IGN_LET_TABELA_TOTAL_bkp,
  titulo = "Óbitos por causas violentas e passagem pelo CIABH, Belo Horizonte e municípios limítrofes, 2020 a 2023",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: INSTITUTO MÉDICO LEGAL",
  x_col = "ANO",
  y_col = "QUANTIDADE",
  fill_col = c("CAUSA_JURIDICA", "PASSAGEM_CIABH"),
...
criar_e_salvar_grafico(
  tipo = "barra_vertical",
  df = homicidio_sexo_LET_TOTAL_bkp,
  titulo = "Óbitos por homicídio de adolescentes e jovens, por sexo, Belo Horizonte, 2020 a 2023",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: INSTITUTO MÉDICO LEGAL",
  x_col = "ANO",
  y_col = "QUANTIDADE",
