...
gerar_tabela(
  ...
  titulo_base = "Tempo médio do óbito, Belo Horizonte, 2022",
  subtitulo = "Letalidade",  # com subtítulo
...
gerar_tabela(
  ...
  titulo_base = "Tempo entre última entrada CIABH e óbito, Belo Horizonte, 2022",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Tempo Médio entre a primeira e a última entrada, Belo Horizonte, 2022",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Tempo entre a primeira e a última entrada, Belo Horizonte, 2022",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Média de entradas, Belo Horizonte, 2022",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Entradas, Belo Horizonte, 2022",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Medidas Protetivas, Belo Horizonte, 2022",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Decisões aplicadas, Belo Horizonte, 2022",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
