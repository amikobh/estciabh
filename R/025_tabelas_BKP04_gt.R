...
gerar_tabela <- function(df, titulo_base, subtitulo = NULL,
  ...
  # Estilo adicional para tabelas com exatamente 5 colunas
  ...
  # Estilo adicional para tabelas com exatamente 7 colunas
  ...
  # Estilo adicional para tabelas com exatamente 8 colunas
  ...
  # Estilo adicional para tabelas com exatamente 9 colunas
...
gerar_tabela(
  ...
  titulo_base = "Total de adolescentes encaminhados, 2024",
...
gerar_tabela(
  df = tabela_atividades_semiliberdade,
...
# Projeto CORRE LEGAL: semiliberdade
gerar_tabela(
  df = tabela_periodo_semiliberdade,
...
# Projeto CORRE LEGAL: semiliberdade
gerar_tabela(
  df = tabela_unidade_semiliberdade,
...
##################################################################################################################
gerar_tabela(
  df = tabela_IDADE_SEXO_semiliberdade,
  titulo_base = "Idade e sexo, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_5 = TRUE  # Não aplicar estilo na primeira coluna
)
...
##################################################################################################################
gerar_tabela(
  df = banco_geral_sem_concurso_semiliberdade,
...
gerar_tabela(
  df = tabela_atividades_internacao,
  titulo_base = "Atividades realizadas, 2024",
  subtitulo = "Projeto CORRE LEGAL: internacao",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
##################################################################################################################
gerar_tabela(
  df = tabela_IDADE_SEXO_internacao,
  titulo_base = "Idade e sexo, 2024",
  subtitulo = "Projeto CORRE LEGAL: internacao",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_5 = TRUE  # Não aplicar estilo na primeira coluna
...
##################################################################################################################
gerar_tabela(
  df = banco_geral_sem_concurso_internacao,
  titulo_base = "Incidência, 2024",
  subtitulo = "Projeto CORRE LEGAL: internacao",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
