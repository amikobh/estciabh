...
gerar_tabela <- function(df, titulo_base, subtitulo = NULL,
                         ...
                         aplicar_estilo_coluna_5 = FALSE,
                         aplicar_estilo_coluna_6 = FALSE,
                         aplicar_estilo_coluna_7 = FALSE,
                         aplicar_estilo_coluna_8 = FALSE,
                         aplicar_estilo_coluna_9 = FALSE,
  ...
  # Gerar o título no formato "TABELA X: [titulo_base]"
  ...
  # Estilo para a última linha (em negrito) – afeta todas as colunas
  tabela <- tabela %>%
    tab_style(
      style = cell_text(weight = "bold"),
  ...
  # Estilos condicionais para colunas específicas (quando aplicável)
  ...
  if (aplicar_estilo_coluna_5 && n_colunas == 5) {
    tabela <- tabela %>%
      tab_style(
        style = cell_text(weight = "bold", color = "black"),
        locations = cells_column_labels(columns = everything())
  ...
  if (aplicar_estilo_coluna_7 && n_colunas == 7) {
    tabela <- tabela %>%
      tab_style(
        style = cell_text(weight = "bold", color = "black"),
        locations = cells_column_labels(columns = everything())
  ...
  if (aplicar_estilo_coluna_8 && n_colunas == 8) {
    tabela <- tabela %>%
      tab_style(
        style = cell_text(weight = "bold", color = "black"),
        locations = cells_column_labels(columns = everything())
  ...
  if (aplicar_estilo_coluna_9 && n_colunas == 9) {
    tabela <- tabela %>%
      tab_style(
        style = cell_text(weight = "bold", color = "black"),
        locations = cells_column_labels(columns = everything())
  ...
  # Estilo condicional para a coluna "VAR%", se existir no dataframe
  ...
  # Estilo específico para tabelas com 3 colunas:
  # - Cabeçalhos: 1ª coluna alinhada à esquerda; 2ª e 3ª à direita.
  # - Células do corpo: linhas não últimas recebem o alinhamento adequado e a última linha mantém o negrito.
  if (n_colunas == 3) {
    tabela <- tabela %>%
      # Cabeçalhos conforme solicitado
      tab_style(
        style = cell_text(weight = "bold", align = "left"),
        locations = cells_column_labels(columns = 1)
      ) %>%
    ...
    # Para as linhas que não são a última: definir o alinhamento sem interferir no peso (negrito já definido para última linha)
    if (nrow(df) > 1) {
      tabela <- tabela %>%
        tab_style(
          style = cell_text(align = "left"),
          locations = cells_body(rows = 1:(nrow(df) - 1), columns = 1)
        ) %>%
        tab_style(
          style = cell_text(align = "right"),
          locations = cells_body(rows = 1:(nrow(df) - 1), columns = 2:3)
        )
    }

    # Para a última linha: reaplicar o estilo para a 1ª coluna (alinhamento à esquerda e negrito)
    tabela <- tabela %>%
      tab_style(
        style = cell_text(weight = "bold", align = "left"),
        locations = cells_body(rows = nrow(df), columns = 1)
      ) %>%
      # Garantir o alinhamento à direita nas colunas 2 e 3 na última linha
      tab_style(
        style = cell_text(align = "right"),
        locations = cells_body(rows = nrow(df), columns = 2:3)
      )
  }

  # Gerar o caminho de saída com o formato "TABELA[X,].png"
...
gerar_tabela(
  ...
  titulo_base = "Incidência Atos Infracionais, 2023 e 2023",
...
gerar_tabela(
  ...
  titulo_base = "Regional de Residência, 2024",
  subtitulo = NULL,  # Sem subtítulo
...
gerar_tabela(
  df = total_MBA_gt,
  titulo_base = "Quantidade de MBAs Cumpridos, 2024",
  subtitulo = NULL,  # Sem subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
...
gerar_tabela(
  df = MOTIVO_MBA,
  titulo_base = "Motivo de expedição do MBA, 2024",
  subtitulo = "MBAs",  # com subtítulo
...
gerar_tabela(
  ...
  titulo_base = "Regional do local de cumprimento, 2024",
...
gerar_tabela(
  ...
  titulo_base = "Dia da semana do cumprimento, 2024",
  subtitulo = "MBAs",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  df = atos_em_foco,
  titulo_base = "Incidência atos em foco, 2024",
...
gerar_tabela(
  ...
  titulo_base = "Incidência homicídio, 2024",
  subtitulo = NULL,  # Sem subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Dia da semana, 2024",
...
gerar_tabela(
  ...
  titulo_base = "Incidência ROUBO, 2024",
  subtitulo = NULL,  # Sem subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Incidência FURTO, 2024",
  subtitulo = NULL,  # Sem subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Incidência posse de drogas para uso pessoal, 2024",
  subtitulo = NULL,  # Sem subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Incidência tráfico de drogas, 2024",
  subtitulo = NULL,  # Sem subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Adolescente Pai ou Mãe, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Adolescente Grávida, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Natureza da Escola, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Trabalho Atual, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Renda Familiar, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Tipo de Moradia, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Natureza da Propriedade, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Uso de Drogas, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Medidas Protetivas, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Decisões em audiências preliminares, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
...
gerar_tabela(
  ...
  titulo_base = "Tempo médio das decisões em audiências preliminares, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Decisões após as audiências preliminares, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = TRUE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Tempo médio das decisões após as audiências preliminares, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Tempo das decisões após audiências preliminares, 2024",
  subtitulo = NULL,  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Quantidade de casos encaminhados, 2024",
...
gerar_tabela(
  ...
  titulo_base = "Incidência atos infracionais, 2024",
  subtitulo = "Ato infracional nas escolas",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Regional da escola, 2024",
  subtitulo = "Ato infracional nas escolas",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Natureza do Trabalho, 2024",
  subtitulo = "Justiça Restaurativa",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Estado civil dos pais, 2024",
  subtitulo = "Justiça Restaurativa",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Medidas socioeducativas, 2024",
  subtitulo = "Justiça Restaurativa",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  ...
  titulo_base = "Total de casos encaminhados, 2024",
...
gerar_tabela(
  ...
  titulo_base = "Regional Residencial, 2024",
  subtitulo = "Projeto CEDIPRO: alunos matriculados",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  df = tabela_total_adls_CORRE,
  titulo_base = "Total de adolescentes incluídos, 2024",
  subtitulo = "Projeto CORRE LEGAL",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
##################################################################################################################
##################################################################################################################
# Projeto CORRE LEGAL: semiliberdade
gerar_tabela(
  df = tabela_atividades_semiliberdade_CORRE,
  titulo_base = "Atividades realizadas, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
# Projeto CORRE LEGAL: semiliberdade
gerar_tabela(
  df = faixa_semiliberdade_atv_CORRE,
  titulo_base = "Frequência dos adolescentes às atividades, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
# Projeto CORRE LEGAL: semiliberdade
gerar_tabela(
  df = tabela_dias_semiliberdade_CORRE,
  titulo_base = "Dias das atividades, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
# Projeto CORRE LEGAL: semiliberdade
gerar_tabela(
  df = tabela_periodo_semiliberdade_CORRE,
  titulo_base = "Turno das atividades, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
# Projeto CORRE LEGAL: semiliberdade
gerar_tabela(
  df = tabela_unidade_semiliberdade_CORRE,
  titulo_base = "Unidade socioeducativa, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
##################################################################################################################
#gerar_tabela(
# df = tabela_IDADE_SEXO_semiliberdade_CORRE,
# titulo_base = "Idade e sexo, 2024",
#  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
# aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
#  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
#)
...
gerar_tabela(
  df = ESCOLARIDADE_semiliberdade_CORRE_TABELA,
  titulo_base = "Escolaridade, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  df = REGIONAL_RESIDENCIAL_banco_semiliberdade_CORRE,
  titulo_base = "Regional de residência, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
##################################################################################################################
gerar_tabela(
  df = banco_geral_sem_concurso_semiliberdade_CORRE,
  titulo_base = "Incidência, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  df = REGIONAL_ATO_banco_semiliberdade_CORRE,
  titulo_base = "Regional ato, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  df = SENTENCA_banco_semiliberdade_CORRE,
  titulo_base = "Sentenças, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  df = PROTETIVAS_banco_semiliberdade_CORRE,
  titulo_base = "Medidas Protetivas, 2024",
  subtitulo = "Projeto CORRE LEGAL: semiliberdade",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
##################################################################################################################
##################################################################################################################
# Projeto CORRE LEGAL: internacao
gerar_tabela(
  df = tabela_atividades_internacao_CORRE,
  titulo_base = "Atividades realizadas, 2024",
  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
# Projeto CORRE LEGAL: internacao
gerar_tabela(
  df = tabela_dias_internacao_CORRE,
  titulo_base = "Dias das atividades, 2024",
  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
# Projeto CORRE LEGAL: internacao
gerar_tabela(
  df = tabela_periodo_internacao_CORRE,
  titulo_base = "Turno das atividades, 2024",
  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
# Projeto CORRE LEGAL: internacao
gerar_tabela(
  df = tabela_unidade_internacao_CORRE,
  titulo_base = "Unidade socioeducativa, 2024",
  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
##################################################################################################################
#gerar_tabela(
# df = tabela_IDADE_SEXO_internacao_CORRE,
#  titulo_base = "Escolaridade, 2024",
#  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
#  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
# aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  df = ESCOLARIDADE_internacao_CORRE_TABELA,
  titulo_base = "Escolaridade, 2024",
  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  df = REGIONAL_RESIDENCIAL_banco_internacao_CORRE,
  titulo_base = "Regional de residência, 2024",
  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
##################################################################################################################
gerar_tabela(
  df = banco_geral_sem_concurso_internacao_CORRE,
  titulo_base = "Incidência, 2024",
  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  df = REGIONAL_ATO_banco_internacao_CORRE,
  titulo_base = "Regional ato, 2024",
  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  df = SENTENCA_banco_internacao_CORRE,
  titulo_base = "Sentença, 2024",
  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
)
...
gerar_tabela(
  df = PROTETIVAS_banco_internacao_CORRE,
  titulo_base = "Medidas Protetivas, 2024",
  subtitulo = "Projeto CORRE LEGAL: internação",  # com subtítulo
  aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_2 = FALSE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Sexo dos adolescentes e jovens vitimados por homicídio e causa ignorada, Belo Horizonte e municípios limítrofes, 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_6 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Raça/cor dos adolescentes e jovens vitimados por homicídio e causa ignorada, Belo Horizonte e municípios limítrofes, 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_6 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  df = passagem_cia_GERAL_HOM_LET_TABELA_TOTAL,
  titulo_base = "Óbitos por homicídio e passagem pelo CIABH, Belo Horizonte e municípios limítrofes, 2020 a 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_6 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  df = passagem_cia_GERAL_IGN_LET_TABELA_TOTAL,
  titulo_base = "Óbitos por causa ignorada e passagem pelo CIABH, Belo Horizonte e municípios limítrofes, 2020 a 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_6 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  df = homicidio_sexo_LET_TOTAL,
  titulo_base = "Óbitos por homicídio de adolescentes e jovens, por sexo, Belo Horizonte, 2020 a 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_6 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Raça/cor, Belo Horizonte e municípios limítrofes, 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_6 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Localidade do óbito, Belo Horizonte e municípios limítrofes, 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_6 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Tempo médio do óbito, 2023",
  subtitulo = "Letalidade",  # com subtítulo
...
gerar_tabela(
  ...
  titulo_base = "Tempo entre última entrada CIABH e óbito, 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Tempo Médio entre a primeira e a última entrada, 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Tempo entre a primeira e a última entrada, 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Média de entradas, 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
...
gerar_tabela(
  ...
  titulo_base = "Decisões aplicadas, 2023",
  subtitulo = "Letalidade",  # com subtítulo
  texto_fonte = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  #aplicar_estilo_condicional = FALSE,  # Estilo condicional desativado
  #aplicar_estilo_coluna_1 = TRUE  # Não aplicar estilo na primeira coluna
