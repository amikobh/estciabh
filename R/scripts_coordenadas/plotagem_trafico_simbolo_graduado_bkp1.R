...
# --- 3. Carregar e processar dados de tráfico de drogas ---
...
print(paste("Pontos de tráfico na região do Barreiro:", nrow(pontos_barreiro)))
...
ggplot() +
  ...
  # Pontos de tráfico com tamanho e cor proporcional ao total
  geom_sf(
    data = coord_trafico,
  ...
  # Escala de tamanho (ajustada para maior densidade)
  scale_size_continuous(
    name = "Nº de Ocorrências",
    range = c(3, 18),     # Aumentado o tamanho máximo
  ...
  # Elementos gráficos
  labs(
    title = "Distribuição espacial: Tráfico de Drogas em Belo Horizonte",
