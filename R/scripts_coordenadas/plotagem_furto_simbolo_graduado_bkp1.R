...
# --- 3. Carregar e processar dados de furto ---
...
print(paste("Pontos de furto na região do Barreiro:", nrow(pontos_barreiro)))
...
ggplot() +
  ...
  # Pontos de furto com tamanho e cor proporcional ao total
  geom_sf(
    data = coord_furto,
  ...
  # Escala de tamanho (ajustada para mais pontos)
  scale_size_continuous(
    name = "Nº de Ocorrências",
    range = c(3, 15),     # Aumentado o tamanho máximo
  ...
  # Elementos gráficos
  labs(
    title = "Distribuição espacial: Furtos em Belo Horizonte",
