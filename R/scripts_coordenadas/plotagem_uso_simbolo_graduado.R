...
coord_uso <- read.csv(file.path(dir_base, "COORDENADAS_USO_DE_DROGAS.csv")) %>%
...
pontos_barreiro <- st_intersection(coord_uso, st_buffer(barreiro_shp, 0.01))
...
ggplot() +
  ...
  # Elementos gráficos
  labs(
    title = "Distribuição de posse de drogas para uso pessoal em Belo Horizonte",
