...
# --- 3. Carregar e processar dados de roubo ---
...
print(paste("Pontos de roubo na região do Barreiro:", nrow(pontos_barreiro)))
...
ggplot() +
  ...
  # Pontos de roubo com tamanho e cor proporcional ao total
  geom_sf(
    data = coord_roubo,
  ...
  scale_size_continuous(
    ...
    range = c(3, 12),     # Ajuste conforme quantidade de agrupamento
  ...
  # Elementos gráficos
  labs(
    title = "Distribuição espacial: Roubos em Belo Horizonte",
