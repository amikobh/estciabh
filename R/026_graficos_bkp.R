...
criar_e_salvar_grafico(
  ...
  titulo = "Incidência Atos Infracionais, 2023",
...
criar_e_salvar_grafico(
  ...
  titulo = "Regional de Residência, 2023",
  subtitulo = NULL,  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  tipo = "barra_horizontal",
  df = atos_em_foco_rmd,
  titulo = "Incidência atos em foco, 2023",
  subtitulo = NULL,  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  x_col = "ATO",
  y_col = "INCIDÊNCIA",
...
criar_e_salvar_grafico(
  ...
  titulo = "Adolescente Pai ou Mãe, 2023",
  subtitulo = "Dados socioeconômicos",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  tipo = "barra_horizontal",
  df = ESTA_GRAVIDA_bkp,
  titulo = "Adolescente Grávida, 2023",
  subtitulo = "Dados socioeconômicos",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Natureza da Escola, 2023",
  subtitulo = "Dados socioeconômicos",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Natureza da Propriedade, 2023",
  subtitulo = "Dados socioeconômicos",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  tipo = "barra_horizontal",
  df = so_decisao_bkp,
  titulo = "Decisões em audiências preliminares, 2023",
  subtitulo = NULL,  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Tempo das decisões em audiências preliminares, 2023",
  subtitulo = NULL,  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  tipo = "barra_horizontal",
  df = so_sentenca_bkp,
  titulo = "Decisões após as audiências preliminares, 2023",
  subtitulo = NULL,  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Tempo das decisões após audiências preliminares, 2023",
  subtitulo = NULL,  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Regional da escola, 2023",
  subtitulo = "Ato infracional nas escolas",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Natureza do Trabalho, 2023",
  subtitulo = "Justiça Restaurativa",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Estado civil dos pais, 2023",
  subtitulo = "Justiça Restaurativa",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Medidas Socioeducativas, 2023",
  subtitulo = "Justiça Restaurativa",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Casos encaminhados, 2023",
...
criar_e_salvar_grafico(
  ...
  titulo = "Regional Residencial, 2023",
  subtitulo = "Projeto CEDIPRO: alunos matriculados",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/SUASE/DOPCAD",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Letalidade por causas externas, Belo Horizonte e municípios limítrofes, 2022",
...
criar_e_salvar_grafico(
  ...
  titulo = "Incidência de óbitos por homicídio, Belo Horizonte e municípios limítrofes, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: INSTITUTO MÉDICO LEGAL",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Incidência de óbitos por causa ignorada, Belo Horizonte e municípios limítrofes, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: INSTITUTO MÉDICO LEGAL",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(tipo = "composto",
                       ...
                       titulo = "Sexo dos adolescente e jovens vitimados por homicídio e causa ignorada, 2022",
...
criar_e_salvar_grafico(
  ...
  titulo = "Raça/cor dos adolescentes e jovens vitimados por homicídio e causa ignorada, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: INSTITUTO MÉDICO LEGAL",
  x_col = "COR",
  y_col = "QUANTIDADE",
...
criar_e_salvar_grafico(
  ...
  titulo = "Óbitos por homicídio e causa ignorada, Belo Horizonte e municípios limítrofes, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: INSTITUTO MÉDICO LEGAL",
  x_col = "ANO",
  y_col = "QUANTIDADE",
...
criar_e_salvar_grafico(
  ...
  titulo = "Óbitos por causas violentas e passagem pelo CIABH, Belo Horizonte e municípios limítrofes, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: INSTITUTO MÉDICO LEGAL",
...
criar_e_salvar_grafico(
  ...
  titulo = "Óbitos por homicídio e passagem pelo CIABH, Belo Horizonte e municípios limítrofes, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: INSTITUTO MÉDICO LEGAL",
  x_col = "IDADE",
  y_col = "QUANTIDADE",
...
criar_e_salvar_grafico(
  ...
  titulo = "Óbitos por causa ignorada e passagem pelo CIABH, Belo Horizonte e municípios limítrofes, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
...
criar_e_salvar_grafico(
  ...
  titulo = "Óbitos por homicídio de adolescentes e jovens, por sexo, Belo Horizonte, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  y_col = "QUANTIDADE",
  fill_col = "SEXO",
...
criar_e_salvar_grafico(
  ...
  titulo = "Raça/cor, Belo Horizonte e municípios limítrofes, Belo Horizonte e municípios limítrofes, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: INSTITUTO MÉDICO LEGAL",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Localidade do óbito, Belo Horizonte e municípios limítrofes, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: INSTITUTO MÉDICO LEGAL",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Tempo entre última entrada CIABH e óbito, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Tempo entre a primeira e a última entrada, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Aplicação de medida protetiva, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  y_col = "QUANTIDADE",
...
criar_e_salvar_grafico(
  ...
  titulo = "Medidas Protetivas, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
...
criar_e_salvar_grafico(
  ...
  titulo = "Decisões aplicadas, 2022",
  subtitulo = "Letalidade",  # Subtítulo personalizado
  caption = "FONTE: VARA INFRACIONAL/INSTITUTO MÉDICO LEGAL",
  y_col = "QUANTIDADE",
  label_col = "PERCENTUAL"
