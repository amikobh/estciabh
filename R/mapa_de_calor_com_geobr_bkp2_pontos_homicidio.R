...
bh <- read_municipality(code_muni = 3106200, year = 2022)
...
# Passo 5: Plotar o mapa de calor com os pontos
...
ggplot() +
  ...
  geom_sf(data = dados_sf, aes(color = "red"), size = 2, shape = 16, show.legend = FALSE) + # Adicionar os pontos sem legenda
