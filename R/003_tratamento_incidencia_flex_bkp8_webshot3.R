...
banco_incidencia_geral$ATO_INFRACIONAL = sub("140.ART.*.*", "INJÚRIA", banco_incidencia_geral$ATO_INFRACIONAL)
banco_incidencia_geral$ATO_INFRACIONAL = sub("140§*.*", "INJÚRIA", banco_incidencia_geral$ATO_INFRACIONAL)
