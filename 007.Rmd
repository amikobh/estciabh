...
Os adolescentes autores de homicídio se encontram na faixa etária de `r banco_HOMICIDIO_snr_SEXO_IDADE_pizza_bkp_rmd[nrow(banco_HOMICIDIO_snr_SEXO_IDADE_pizza_bkp_rmd)-0,1]` a `r banco_HOMICIDIO_snr_SEXO_IDADE_pizza_bkp_rmd[nrow(banco_HOMICIDIO_snr_SEXO_IDADE_pizza_bkp_rmd)-1,1]`.
\leavevmode
\newline
\newline
